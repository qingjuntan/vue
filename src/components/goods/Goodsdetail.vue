<template>
  <div>
    ...
    <div class="outer-swiper">
      <div class="swiper">
        <mylb :url="'getthumimages/'+ $route.params.goodsid "></mylb>
      </div>
    </div>
    <div class="product-desc">
      <ul>
        ...
        <li>
          ...
          <mt-button type="danger" @click="click">加入购物车</mt-button>
        </li>
      </ul>
    </div>
    ...
    <div class="product-props">
      <ul>
        ...
        <li>上架时间：{{goodsInfo.add_time |time}}</li>
      </ul>
    </div>
    <div class="product-info">
      <ul>
        <li>
          <mt-button type="primary" size="large" plain @click="productPl">图文介绍</mt-button>
        </li>
        <li>
          <mt-button type="danger" size="large" plain @click="productSay">商品评论</mt-button>
        </li>
      </ul>
    </div>
  </div>
